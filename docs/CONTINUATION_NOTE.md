...
**Current version:** v0.70.140 (see `custom_components/esphome_touch_designer/manifest.json`, `frontend/package.json`, `README.md`).
...
> "I'm working on ESPHome Touch Designer (v0.70.140). See docs/CONTINUATION_NOTE.md for context. [Then describe your new task.]"

---

*Last updated: after v0.70.140 release.*
